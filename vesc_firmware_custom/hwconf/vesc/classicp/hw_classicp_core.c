...
void hw_setup_adc_channels(void) {
	...
	ADC_RegularChannelConfig(ADC1, ADC_Channel_5, 6, ADC_SampleTime_15Cycles);			// 15 Smart Switch
	ADC_RegularChannelConfig(ADC1, ADC_Channel_8, 7, ADC_SampleTime_15Cycles);			// 18 TEMP_MOS
	...
	ADC_RegularChannelConfig(ADC2, ADC_Channel_3, 7, ADC_SampleTime_15Cycles);			// 19 TEMP_MOS2
