...
#ifndef HW_CLASSIC_CORE_H_
#define HW_CLASSIC_CORE_H_

#ifdef HWCLASSIC
	#define HW_NAME					"Classic"
#else
...
#define PHASE_FILTER_OFF()		palSetPad(GPIOB, 12); palSetPad(GPIOC, 14); palSetPad(GPIOC, 15)
#define PHASE_FILTER_ON()		palClearPad(GPIOB, 12); palClearPad(GPIOC, 14); palClearPad(GPIOC, 15)
